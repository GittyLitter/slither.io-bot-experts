...
var userInterface = window.userInterface = (function() {
    ...
    return {
        ...
        initOverlays: function() {
            ...
            logOverlay.style.top = '5px';
            logOverlay.style.width = '260px';
            logOverlay.style.height = '65px';
            logOverlay.style.color = '#777777';
            logOverlay.style.fontSize = '14px';
            logOverlay.style.padding = '5px';
            logOverlay.style.borderRadius = '5px';
            logOverlay.className = 'nsi';
            ...
            userInterface.overlays.logOverlay = logOverlay;
        ...
        toggleLogOverlay: function() {
            window.logOverlay = !window.logOverlay;
            window.log('Log overlay set to: ' + window.logOverlay);
            userInterface.savePreference('logOverlay', window.logOverlay);
        },
        ...
        onkeydown: function(e) {
            ...
            if (window.playing) {
                ...
                // Letter 'J' to toggle log overlay
                if (e.keyCode === 74) {
                    userInterface.toggleLogOverlay();
                }
        ...
        updateLogOverlay: function(message, prevContent) {
            var oContent = [prevContent];
